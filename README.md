# index.html
git remote add origin https://github.com/Bifahmi/Bee.github.io
...
<body>
  ...
  <footer class="page-footer font-small blue fixed-bottom">
    ...
    <div class="footer-copyright text-center py-3 text-secondary"><small> Made with
        ...
        <a href="https://www.instagram.com/bifahmi/"  class="text-decoration-none text-secondary">LOVE</a></small>
    </div>
    <!-- Copyright -->
